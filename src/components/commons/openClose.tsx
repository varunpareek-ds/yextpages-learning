          ...
          <div className={"opendot green-dot"}>
            ...
            <div className="hours-info ">
              ...
              <span className="lowercase">
                {OpenStausFunctions.formatTime(currentInterval.start).replace(':00','')}
              </span>{" "}
              to{" "}
              <span className="lowercase">
                {OpenStausFunctions.formatTime(currentInterval.end).replace(':00','')}
              </span>{" "}
            </div>
          </div>
        );
          ...
          <div className={"closeddot 4"}>
            <div className="red-dot">
              ...
              <div className="hours-info ">
                ...
                {"Opens at "}
                <span className="lowercase">
                  {OpenStausFunctions.formatTime(nextInterval.start).replace(':00','')}
                </span>{" "}
                {week[Day]}
              </div>
            </div>{" "}
