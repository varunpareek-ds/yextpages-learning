...
export default function InputDropdown({
  ...
  // useEffect(()=>{
  //   console.log('locationResults.length === 0 && !loading', locationResults.length ,loading);
  //   if(!loading && locationResults.length === 0 && latestUserInput!='' && startgeocode){
  //   Getpostalcodetolatlng(latestUserInput,searchActions,locationResults,loading);
  //   }
  // },[locationResults])
