...
export const baseuRL = "https://liveapi.yext.com/v2/accounts/me/entities/geosearch?radius=500"
export const apikey_for_entity = "ea7ea73738da090eba9cafbc45220b0b"
export const experienceKey = "matalan-search";
export const apiKey = "50f6010c48792a06524b4fe3471d7840";
...
export const logo = `<a href="/"><svg class="hidden lg:block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 232 96">
...
export const Mid_Logo =`<svg id="Group_2499" data-name="Group 2499" xmlns="http://www.w3.org/2000/svg" width="143" height="56" viewBox="0 0 143 56">
<path id="Path_563" data-name="Path 563" d="M0,56H143V0H0Z" fill="#ad1e1f" fill-rule="evenodd"/>
<path id="Path_564" data-name="Path 564" d="M138.751,7l-5-.01a.75.75,0,1,0,0,1.5l5,.01a.75.75,0,1,0,0-1.5Zm-10-.018-5-.01a.75.75,0,0,0,0,1.5l5,.01a.75.75,0,0,0,0-1.5Zm-10-.019-5-.009a.75.75,0,0,0,0,1.5l5,.01a.75.75,0,1,0,0-1.5Zm-10-.018-5-.01a.75.75,0,0,0,0,1.5l5,.01a.75.75,0,1,0,0-1.5Zm-10-.018-5-.01a.75.75,0,0,0,0,1.5l5,.01a.75.75,0,0,0,0-1.5Zm-10-.019-5-.009a.75.75,0,1,0,0,1.5l5,.01a.75.75,0,1,0,0-1.5Zm-10-.018-5-.009a.75.75,0,1,0,0,1.5l5,.01a.75.75,0,1,0,0-1.5Zm-10-.018-5-.01a.75.75,0,0,0,0,1.5l5,.01a.75.75,0,1,0,0-1.5Zm-10-.019-5-.009a.75.75,0,0,0,0,1.5l5,.01a.75.75,0,1,0,0-1.5Zm-10-.018-5-.009a.75.75,0,0,0,0,1.5l5,.01a.75.75,0,0,0,0-1.5Zm-10-.018-5-.01a.75.75,0,1,0,0,1.5l5,.01a.75.75,0,1,0,0-1.5Zm-10-.018-5-.01a.75.75,0,0,0,0,1.5l5,.01a.75.75,0,1,0,0-1.5Zm-10-.019-5-.009a.75.75,0,1,0,0,1.5l5,.01a.75.75,0,0,0,0-1.5Zm-10-.018-5-.01a.75.75,0,1,0,0,1.5l5,.01a.75.75,0,1,0,0-1.5Z" fill="#fff"/>
<g id="Group_2498" data-name="Group 2498">
  <path id="Path_565" data-name="Path 565" d="M119.7,23.032v11.9l-10.6-11.9-1.594,0V36.967h1.4v-11.9l10.55,11.856.039.044,1.6,0V23.032ZM101.407,31.26h-6.34l3.17-6.308,3.17,6.309ZM98.973,23.1l-.036-.072h-1.4l-7.05,13.938,1.665,0,2.265-4.437h7.641l2.265,4.437,1.665,0L98.973,23.1ZM80.42,35.7V23.032h-1.4V36.967h9.944V35.7Zm-7.5-4.44h-6.34l3.17-6.308,3.17,6.309ZM70.484,23.1l-.036-.072h-1.4L62,36.968l1.664,0,2.265-4.437h7.641l2.265,4.437,1.665,0ZM53.4,23.032V24.3H58.31V36.967h1.4V24.3h4.916V23.032ZM51.45,31.26H45.109l3.17-6.308,3.17,6.309Zm-2.4-8.09-.07-.14h-1.4l-7.05,13.938,1.665,0,2.265-4.437H52.1l2.266,4.437,1.665,0-6.98-13.8Zm-11.923-.138H35.4L30,34.871,24.611,23.032h-1.73L21,36.967h1.487L24.055,25.3l5.29,11.668h1.316L35.952,25.3,37.52,36.967h1.487Z" fill="#fefefe" fill-rule="evenodd"/>
</g>
</svg>
`;

export const small_logo=`<a href="https://www.matalan.co.uk/"><svg id="Group_2500" data-name="Group 2500" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 56 56">
<path id="Path_566" data-name="Path 566" d="M0,56H56V0H0Z" fill="#ad1e1f" fill-rule="evenodd"/>
<path id="Path_567" data-name="Path 567" d="M50.5,6.75h-5a.75.75,0,0,0,0,1.5h5a.75.75,0,0,0,0-1.5Zm-10,0h-5a.75.75,0,0,0,0,1.5h5a.75.75,0,0,0,0-1.5Zm-10,0h-5a.75.75,0,0,0,0,1.5h5a.75.75,0,0,0,0-1.5Zm-10,0h-5a.75.75,0,0,0,0,1.5h5a.75.75,0,0,0,0-1.5Zm-10,0h-5a.75.75,0,0,0,0,1.5h5a.75.75,0,0,0,0-1.5Z" fill="#fff"/>
<path id="Path_568" data-name="Path 568" d="M39.02,20.143H36.228l-8.7,19.1-8.7-19.1H16.033L13,42.626h2.4L17.929,23.8l8.537,18.826,1.06,0,1.062,0L37.125,23.8l2.529,18.823h2.4Z" fill="#fefefe" fill-rule="evenodd"/>
</svg></a>
`;
